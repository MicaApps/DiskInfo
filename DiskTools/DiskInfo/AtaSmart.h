...
{
public:
	static CAtaSmart& get_instance() {	//单例模式
...
/// <summary>
/// AtaSmartInit，在获取数据时需要先调用一次
/// </summary>
/// <param name="useWmi"></param>
/// <param name="advancedDiskSearch"></param>
/// <param name="flagChangeDisk"></param>
/// <param name="workaroundHD204UI"></param>
/// <param name="workaroundAdataSsd"></param>
...
extern "C" IMPORT_DLL wchar_t* GetModel() {
	CString cstrStr = CAtaSmart::get_instance().vars[selectedDrive].Model;	//硬盘类型
	return cstrStr.AllocSysString();
}
